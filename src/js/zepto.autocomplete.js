...
var ZeptoAutocomplete = {
  init: function(limit, data, caseSensitive, showFunc, hideFunc, onSelect, successHandler) {
    var _this = this;
    this.limit = limit;
    this.data = data;
    ...
    this.showFunction = typeof showFunc == 'function' ? showFunc : function() { _this.resultContainer.show(); };
    this.hideFunction = typeof hideFunc == 'function' ? hideFunc : function() { _this.resultContainer.hide(); };
  ...
  autocomplete: function(options) {
    ...
    if (this._isLocal(options)) {
      this._initLocal(options.limit, options.data, options.caseSensitive, options.show, options.hide, options.onSelect, options.successHandler);
      return;
    }
    if (this._isRemote(options)) {
      this._initRemote(options.limit, options.data, options.caseSensitive, options.show, options.hide, options.onSelect, options.successHandler);
    }
  },
  ...
  _initLocal: function(limit, data, caseSensitive, showFunc, hideFunc, onSelect, successHandler) {
  ...
  _initRemote: function(limit, data, caseSensitive, showFunc, hideFunc, onSelect, successHandler) {
    this.init(limit, data, caseSensitive, showFunc, hideFunc, onSelect,successHandler);
    var searchTextField = $('.autocomplete-input');
    var _this = this;
