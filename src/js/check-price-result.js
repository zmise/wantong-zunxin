      ...
      success: function (data) {
        ...
        if (items.code == 'ok') {
          ...
          if (item.houseType === '1') {
            str += '普通住宅，而且距上次交易';
            if (item.term === '1') {
              str += '还不满2年，需要按5%税率进行征收（城建及教育附加需要按增值税的12%进行征收</p><p class="fb">公式 = 过户价 ÷ 1.05 × 5.6%；</p>';
            } else {
            ...
            // 非普通住宅
            if (item.term === '1') {
              str += '非普通住宅，而且距上次交易不满2年，需要按5%税率进行征收（城建及教育附加需要按增值税的12%进行征收）</p><p class="fb">公式 = 过户价 ÷ 1.05 × 5.6%；</p>';
            } else {
              str += '非普通住宅，虽然距上次交易已满2年，仍需要按5%税率进行征收（城建及教育附加需要按增值税的12%进行征收）</p><p class="fb">公式 = (过户价 - 登记价)÷ 1.05×5.6%；</p>';
            }
          }
